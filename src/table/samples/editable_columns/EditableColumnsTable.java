package table.samples.editable_columns;
...
public class EditableColumnsTable extends DefaultTable<Person> {
	
	protected PersonList list;

	public EditableColumnsTable(Composite parent, int style, PersonList list) {
		super(parent, style);
